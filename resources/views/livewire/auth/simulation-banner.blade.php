        ...
        <div class="px-4 py-2.5 bg-yellow-100 border-b border-yellow-300">
            <div class="flex items-center justify-between gap-3">
                ...
                <div class="flex items-center gap-2 flex-1 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-xs font-semibold text-yellow-900">Mode Simulation</p>
            ...
            <div class="mt-1.5 flex items-start gap-1.5">
                ...
                <p class="text-[10px] text-yellow-700 leading-tight">
                    Vous êtes connecté en mode simulation ({{ app()->environment() }}). Cliquez sur "Quitter" pour vous déconnecter et désactiver la simulation.
                </p>
            </div>
        </div>
    @endif
